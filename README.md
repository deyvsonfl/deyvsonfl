...
### `< Desenvolvedor Web em formação />` · Pernambuco, Brasil 🌵

[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=18&pause=1000&color=F7A800&center=true&vCenter=true&width=500&lines=Estudante+de+Desenvolvimento+Web;Apaixonado+por+código+limpo;Construindo+o+futuro+uma+linha+por+vez)](https://git.io/typing-svg)
...
const deyvson = {
  ...
  idade:      26,
  origem:     "Pernambuco 🌴",
  status:     "Estudando Desenvolvimento Web",
  foco:       ["Front-end", "UI/UX", "Boas práticas"],
  objetivo:   "Transformar ideias em interfaces incríveis",
  curiosidade: "Nascido em Pernambuco, construído no código 🚀"
};
```
...
- ⚛️ **React** — Componentes, hooks e gerenciamento de estado
- 🔷 **TypeScript** — Tipagem estática para código mais robusto
- 🎨 **CSS avançado** — Animações, responsividade e design moderno
